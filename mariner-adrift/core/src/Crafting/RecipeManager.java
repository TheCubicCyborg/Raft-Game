...
public class RecipeManager {
	...
	static{
		...
		recipes.add(24, new Recipe(false, new ArrayList<Item>(temp), new ArrayList<Item>(temp2)));
		temp.clear();
		temp2.clear();
		...
		recipes.add(25, new Recipe(false, new ArrayList<Item>(temp), new ArrayList<Item>(temp2)));
		temp.clear();
		temp2.clear();
		...
		recipes.add(26, new Recipe(false, new ArrayList<Item>(temp), new ArrayList<Item>(temp2)));
		temp.clear();
		temp2.clear();
		...
		recipes.add(27, new Recipe(false, new ArrayList<Item>(temp), new ArrayList<Item>(temp2)));
		temp.clear();
		temp2.clear();
		...
		recipes.add(4, new Recipe(false, new ArrayList<Item>(temp), new ArrayList<Item>(temp2)));
		temp.clear();
		temp2.clear();
		
		temp.add(new Item(4, 9000));
		temp2.add(new Item(5, 1));
		recipes.add(5, new Recipe(false, new ArrayList<Item>(temp), new ArrayList<Item>(temp2)));
		temp.clear();
		temp2.clear();
		...
		recipes.add(28, new Recipe(false, new ArrayList<Item>(temp), new ArrayList<Item>(temp2)));
		temp.clear();
		temp2.clear();
		
		temp.add(new Item(0, 20));
		temp2.add(new Item(29, 1));
		recipes.add(29, new Recipe(false, new ArrayList<Item>(temp), new ArrayList<Item>(temp2)));
		temp.clear();
		temp2.clear();
	}
}